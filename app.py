...
PRINTER_AGENT_URL = os.getenv("PRINTER_AGENT_URL")
...
# def send_to_print_agent(tspl):
#     url = "http://<mini-pc-ip>:9000/print"
#     try:
#         resp = requests.post(url, json={"tspl": tspl}, timeout=5)
#         print("[PRINT AGENT RESPONSE]", resp.text)
#     except Exception as e:
#         print("[PRINT ERROR]", e)
